...
################################################################
# This is a generated script based on design: wtfhe_arm
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set HW_RST [ create_bd_port -dir I HW_RST ]
  set LED [ create_bd_port -dir O -from 7 -to 0 LED ]

  # Create instance: BOOTSTRAPPING_ARM_1, and set properties
  set BOOTSTRAPPING_ARM_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:BOOTSTRAPPING_ARM:1.0 BOOTSTRAPPING_ARM_1 ]
  ...
  connect_bd_net -net BOOTSTRAPPING_ARM_1_ADDRB [get_bd_pins BOOTSTRAPPING_ARM_1/ADDRB] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net BOOTSTRAPPING_ARM_1_DINB [get_bd_pins BOOTSTRAPPING_ARM_1/DINB] [get_bd_pins blk_mem_gen_0/dinb]
  connect_bd_net -net BOOTSTRAPPING_ARM_1_DONE [get_bd_pins BOOTSTRAPPING_ARM_1/DONE] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net BOOTSTRAPPING_ARM_1_ENB [get_bd_pins BOOTSTRAPPING_ARM_1/ENB] [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net BOOTSTRAPPING_ARM_1_LED [get_bd_ports LED] [get_bd_pins BOOTSTRAPPING_ARM_1/LED]
  connect_bd_net -net BOOTSTRAPPING_ARM_1_WEB [get_bd_pins BOOTSTRAPPING_ARM_1/WEB] [get_bd_pins blk_mem_gen_0/web]
  connect_bd_net -net HW_RST_1 [get_bd_ports HW_RST] [get_bd_pins BOOTSTRAPPING_ARM_1/HW_RST] [get_bd_pins blk_mem_gen_0/rstb]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins BOOTSTRAPPING_ARM_1/DOUTB] [get_bd_pins blk_mem_gen_0/doutb]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins BOOTSTRAPPING_ARM_1/CLK] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins BOOTSTRAPPING_ARM_1/CONTROL] [get_bd_pins processing_system7_0/GPIO_O]
