...
--Command     : generate_target wtfhe_arm_wrapper.bd
--Design      : wtfhe_arm_wrapper
...
entity wtfhe_arm_wrapper is
  port (
    ...
    gpio_rtl_0_tri_io : inout STD_LOGIC_VECTOR ( 0 to 0 )
  );
end wtfhe_arm_wrapper;

architecture STRUCTURE of wtfhe_arm_wrapper is
  component wtfhe_arm is
  port (
    HW_RST : in STD_LOGIC;
    LED : out STD_LOGIC_VECTOR ( 7 downto 0 );
...
wtfhe_arm_i: component wtfhe_arm
     port map (
