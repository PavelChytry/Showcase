...
begin
	...
	l_acc : ACCUMULATOR port map (CLK => CLK, RST => RST, PULSE => PULSE_ADD_L, A => T_OUT_L, Y => Y(0));
	...
	r_acc : ACCUMULATOR port map (CLK => CLK, RST => RST, PULSE => PULSE_ADD_R, A => T_OUT_R, Y => Y(1));
