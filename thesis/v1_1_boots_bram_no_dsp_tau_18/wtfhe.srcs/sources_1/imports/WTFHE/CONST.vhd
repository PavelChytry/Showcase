...
package CONST is
	...
	constant TAU							: integer := 18; --18 -- 20 novì
	constant NU                             : integer := 4;
		
	-- UART parameters
	constant BAUD_RATE                  : integer := 115200;
    constant NO_OF_TRANSFERRED_BITS     : integer := 8;
	constant NO_OF_INPUT_BITS			: integer := 32; --320 -- N * 20
	constant NO_OF_OUTPUT_BITS          : integer := (N + 1) * 32;
	constant CNT_UART_WIDTH				: integer := 12;
