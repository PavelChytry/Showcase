...
package CONST is
	...
	constant ROW_WIDTH                     : integer := 4; -- 2^ROW_WIDTH > (K + 1) * L
	...
	constant NO_OF_OUTPUT_BITS          : integer := (N + 1) * 32; -- TLWE Sample
	constant CNT_UART_WIDTH				: integer := 12; -- 2^CNT_WIDTH >= (DIM * 3 / 2) * (K + 1) * ((K + 1) * L) * N
